  ...
  return (
    ...
    >
      <div className="header-box">
        ...
        <div className="row">
          {" "}
          {/* Bootstrap classes + svg icons https://getbootstrap.com/docs/5.3/getting-started/introduction/ */}
          <div className="col-2" />
          <div className="col-2">
            {" "}
            <a href="/" style={{ textDecorationLine: "none" }}>
              {" "}
              <h5 className="nav-box-1">
                {" "}
                About
                <svg
          ...
          {/*[3], paths made with href*/}
          <div className="col-2">
            {" "}
            <a href="/houses" style={{ textDecorationLine: "none" }}>
              {" "}
              <h5 className="nav-box-2">
                {" "}
                Houses{" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          {/* [2], style attribute is weird https://www.w3schools.com/react/react_css.asp*/}
          <div className="col-2">
            {" "}
            <a href="/broker" style={{ textDecorationLine: "none" }}>
              {" "}
