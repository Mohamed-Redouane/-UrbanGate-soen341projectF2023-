...
//a href works well with React Router, check React Router Documentation
    return (
        ...
        <div className="row"> 
        <div className="col-3" style={{textAlign: "center", border: "solid", backgroundColor: "white"}}> <a href="/"> <h5 style={{color: "black"}}> About  </h5> </a> </div> <!-- Style attribute is weird for React, look at documenation-->
