...
const MortgageCalculator: React.FC = () => {
  ...
  const calculateMortgage = () => {
    ...
    setSentence("Your monthly payment for a duration of " + term + " year(s) would be: $" + amount + "/month."); 
    }
    }
  };
  ...
  return (
    <div style={{width:"900px"}}>
      ...
      >
        ...
        <small className="prompt">Please enter numerical values to estimate your monthly payment.</small>
